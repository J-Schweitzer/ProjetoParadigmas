...
/**
 * Tela Administrativa com funcionalidades:
 * 1. Relatórios de clientes e pets
 * 2. Cadastro de clientes e pets
 * 3. Cadastro de serviços
 * 4. Cadastro de atendimentos
 *
 * Organizado em Tabs para facilitar a navegação.
 *
 * @author Joao
 */
public class TelaAdmV extends JFrame {
    ...
    private void carregarDadosAtendimentos() {
        ...
        for (AtendimentoM a : atendimentos) {
            modeloAtendimentos.addRow(new Object[]{
                    a.getIdAtendimento(),
                    a.getDataAtendimento().format(dtf),
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            TelaAdmV telaAdmV = new TelaAdmV();
